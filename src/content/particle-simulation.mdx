...
considered “done” exactly when the work queue is empty AND the in-flight counter is zero. That definition is
cheap to test and doesn’t require per-task joins.
